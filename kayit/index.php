  ...
  <div class="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
    <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
      ...
      <div class="mt-12 flex flex-col items-center">
        ...
        <h1 class="text-2xl xl:text-3xl font-extrabold"> Kayıt Oluştur </h1>
        <div class="w-full flex-1 mt-8">
        
        <!----
        Kayıt Formu Başlangıç--->
        <form role="form" action="" id="kayitformu" method="POST" onsubmit="return false;">
          <div class="flex flex-col items-center">
            ...
            <input class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" 
                name="soyad" type="text" placeholder="Soyadınız" /> 
            <input class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" 
            ...
            <input class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" 
                    name="sifretekrar" type="password" placeholder="Şifrenizi Onaylayın" />

          <div class="mx-auto max-w-xs"> 
                <button type="submit" onclick="kayitbtn();" class="mt-5 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
...
<!---======================--->
<script src="../ajax/js/kayit.js"></script>
        <!---======================--->
</html>